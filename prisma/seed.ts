...
const AIRDROP_TASKS = [
  ...
  { key: "follow_x", title: "Follow on X", description: "Follow @Blobbie on X. Verified manually by the team.", points: 40, type: "MANUAL", status: "ACTIVE", requiresAdmin: true, sortOrder: 8 },
  { key: "join_telegram", title: "Join Telegram", description: "Join the Blobbie Telegram. Verified manually by the team.", points: 40, type: "MANUAL", status: "ACTIVE", requiresAdmin: true, sortOrder: 9 },
] as const;
