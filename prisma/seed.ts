...
const AIRDROP_TASKS = [
  ...
  { key: "buy_ticket", title: "Buy at least 1 Daily Rewards Draw ticket", description: "Purchase at least one ticket in an open round.", points: 100, type: "ONE_TIME", status: "ACTIVE", requiresAdmin: false, sortOrder: 3 },
